...
class Hint:
    ...
    def translate_expr(self, expr):
        ...
        if isinstance(expr, str):
            if expr not in self.Table:
                return None

            ret_str = self.Table[expr]
            return ret_str
    ...
    def build_hint_from_constraints(self, hinted_constraints, func_list):
    ...
    def gen_stmt_from_hint(self):
        ...
        # # print(self.hint_cond_list)
        len_compare = len(self.hint_compare)
        # # print(self.hint_compare)
        len_const = len(self.hint_const)
        # # print(self.hint_const)
