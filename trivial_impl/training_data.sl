...
(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (bvnot x))) (let ((_let_2 (bvand #x0000000000000001 _let_1))) (let ((_let_3 (bvadd #x0000000000000001 (shr16 x)))) (let ((_let_4 (bvand #x0000000000000001 (shr4 (shl1 x))))) (let ((_let_5 (if0 _let_4 _let_3 _let_2))) (let ((_let_6 (if0 _let_4 _let_3 #x0000000000000001))) (let ((_let_7 (if0 _let_4 _let_3 #x0000000000000000))) (let ((_let_8 (bvand #x0000000000000001 (shr16 _let_1)))) (if0 (bvand #x0000000000000001 (shr1 _let_1)) (if0 _let_8 _let_5 (if0 _let_2 _let_6 _let_7)) (if0 _let_8 (if0 (bvand #x0000000000000001 x) _let_7 _let_6) _let_5)))))))))))
...
(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr16 (shl1 (shr4 x))))) (let ((_let_2 (bvand #x0000000000000001 (shr1 x)))) (if0 (bvand #x0000000000000001 x) (if0 _let_2 _let_1 x) (if0 _let_2 (bvor #x0000000000000001 x) _let_1)))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (bvor #x0000000000000001 (shl1 x)))) (let ((_let_2 (bvand #x0000000000000001 (shr16 x)))) (let ((_let_3 (if0 _let_2 _let_1 (shr4 x)))) (if0 (bvand #x0000000000000001 (bvnot x)) (if0 (bvand #x0000000000000001 (shr1 x)) _let_3 (if0 _let_2 _let_1 (shr4 (bvadd x (bvnot #x0000000000000000))))) _let_3)))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (if0 (bvand #x0000000000000001 (shr16 (bvnot x))) (bvor x (bvnot (bvadd #x0000000000000001 x))) (shl1 (shl1 x))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr16 x))) (let ((_let_2 (bvor #x0000000000000001 _let_1))) (let ((_let_3 (bvand #x0000000000000001 (shr1 x)))) (let ((_let_4 (bvand #x0000000000000001 (shr4 x)))) (if0 (bvand #x0000000000000001 x) (if0 _let_3 (if0 _let_4 _let_2 #x0000000000000000) #x0000000000000000) (if0 _let_4 (if0 (bvand #x0000000000000001 _let_1) (if0 _let_3 _let_1 #x0000000000000001) (if0 _let_3 _let_2 #x0000000000000001)) #x0000000000000001)))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr4 x))) (let ((_let_2 (shr1 x))) (let ((_let_3 (bvadd _let_2 _let_1))) (let ((_let_4 (bvor x (shr1 (bvand x _let_1))))) (let ((_let_5 (shl1 x))) (let ((_let_6 (bvand #x0000000000000001 (bvor x (shr4 _let_5))))) (let ((_let_7 (shr16 x))) (let ((_let_8 (bvor x _let_7))) (let ((_let_9 (bvnot x))) (let ((_let_10 (bvor x _let_5))) (let ((_let_11 (shr16 _let_2))) (if0 (bvand #x0000000000000001 (shr4 _let_10)) (if0 _let_6 (if0 (bvand #x0000000000000001 (bvnot (bvand x _let_2))) (if0 (bvand #x0000000000000001 (bvor _let_9 _let_1)) (if0 (bvand #x0000000000000001 (shr4 _let_8)) (if0 (bvand #x0000000000000001 (bvor x (shr4 _let_9))) (if0 (bvand #x0000000000000001 (bvor x _let_11)) (if0 (bvand #x0000000000000001 (bvadd x _let_11)) (if0 (bvand #x0000000000000001 (shr16 _let_10)) (if0 (bvand #x0000000000000001 (bvor _let_9 _let_7)) (if0 (bvand #x0000000000000001 (shr1 _let_8)) _let_3 _let_4) _let_4) _let_4) _let_4) _let_3) _let_3) _let_3) _let_4) _let_4) _let_3) (if0 _let_6 _let_4 _let_3))))))))))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr1 x))) (let ((_let_2 (bvand #x0000000000000001 x))) (if0 (bvand #x0000000000000001 (shr16 x)) (if0 _let_2 (shl1 #x0000000000000001) _let_1) (if0 _let_2 _let_1 (bvadd #x0000000000000001 (bvor #x0000000000000001 x)))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr1 x))) (let ((_let_2 (bvnot x))) (let ((_let_3 (shr16 _let_2))) (let ((_let_4 (bvand #x0000000000000001 (shr16 x)))) (let ((_let_5 (if0 _let_4 _let_3 (shr4 _let_1)))) (let ((_let_6 (shr4 (shr1 (shl1 x))))) (let ((_let_7 (if0 _let_4 _let_3 _let_6))) (let ((_let_8 (bvand #x0000000000000001 _let_2))) (if0 (bvand #x0000000000000001 (shr4 x)) (if0 _let_8 (if0 (bvand #x0000000000000001 _let_1) _let_7 _let_6) _let_5) (if0 _let_8 _let_7 _let_5)))))))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (if0 (bvand #x0000000000000001 (shr16 x)) (bvnot (bvxor x (shl1 x))) (shl1 (bvand #x0000000000000001 x))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (if0 (bvand #x0000000000000001 (bvnot x)) (bvadd #x0000000000000001 (bvor #x0000000000000001 x)) (bvadd #x0000000000000001 (shr16 x))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (if0 (bvand #x0000000000000001 (shr4 (shl1 x))) (bvand #x0000000000000001 (bvnot x)) (bvand x (shr4 x))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr16 x))) (let ((_let_2 (bvand #x0000000000000001 _let_1))) (let ((_let_3 (if0 _let_2 _let_1 (shl1 (bvnot (bvor #x0000000000000001 x)))))) (if0 (bvand #x0000000000000001 x) (if0 _let_2 (shr16 (bvadd x _let_1)) (shl1 (bvnot (bvxor #x0000000000000001 x)))) (if0 (bvand #x0000000000000001 (shr1 x)) (if0 (bvand #x0000000000000001 (shr4 x)) _let_1 _let_3) _let_3))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr1 x))) (if0 (bvand #x0000000000000001 x) _let_1 (bvor x _let_1))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr16 (shr4 (shr4 x))))) (let ((_let_2 (bvand #x0000000000000001 (shr1 x)))) (if0 (bvand #x0000000000000001 (bvnot x)) (if0 _let_2 (shl1 x) _let_1) (if0 _let_2 _let_1 (shl1 (bvxor #x0000000000000001 x)))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (if0 (bvand #x0000000000000001 x) (shl1 x) (shr1 (bvand x (shr16 x)))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shl1 x))) (let ((_let_2 (bvnot _let_1))) (let ((_let_3 (bvand #x0000000000000001 (shr4 _let_1)))) (let ((_let_4 (bvnot x))) (if0 (bvand #x0000000000000001 (shr16 _let_4)) (if0 _let_3 _let_2 (bvnot (bvand #x0000000000000001 x))) (if0 (bvand #x0000000000000001 _let_4) (if0 _let_3 _let_2 (bvnot #x0000000000000000)) (if0 _let_3 _let_2 (bvnot #x0000000000000001)))))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shl1 x))) (let ((_let_2 (shr16 _let_1))) (let ((_let_3 (bvadd #x0000000000000001 x))) (let ((_let_4 (if0 (bvand #x0000000000000001 (shr1 (shr1 x))) _let_2 _let_3))) (let ((_let_5 (bvnot x))) (let ((_let_6 (bvand #x0000000000000001 (shr4 _let_5)))) (let ((_let_7 (bvand #x0000000000000001 _let_2))) (let ((_let_8 (bvand #x0000000000000001 (shr4 _let_1)))) (let ((_let_9 (bvand #x0000000000000001 x))) (let ((_let_10 (bvand #x0000000000000001 (shr16 _let_5)))) (if0 (bvand #x0000000000000001 (shr1 _let_5)) (if0 _let_10 _let_4 (if0 _let_8 (if0 _let_6 _let_4 (if0 _let_9 _let_4 _let_3)) (if0 _let_6 (if0 _let_9 _let_2 _let_4) _let_4))) (if0 _let_10 (if0 _let_8 (if0 _let_6 (if0 _let_9 _let_3 _let_4) (if0 _let_9 _let_3 _let_2)) (if0 _let_6 _let_4 (if0 _let_7 _let_3 (if0 _let_9 _let_2 _let_3)))) (if0 _let_8 (if0 _let_7 _let_3 _let_4) (if0 _let_6 _let_4 _let_2)))))))))))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr16 x))) (let ((_let_2 (bvxor x _let_1))) (let ((_let_3 (shr4 x))) (let ((_let_4 (bvnot _let_3))) (let ((_let_5 (if0 (bvand #x0000000000000001 (shr16 _let_3)) _let_4 _let_2))) (let ((_let_6 (bvand #x0000000000000001 _let_3))) (let ((_let_7 (shr1 x))) (let ((_let_8 (bvand #x0000000000000001 (shr16 _let_7)))) (let ((_let_9 (bvnot x))) (let ((_let_10 (bvand #x0000000000000001 (shr1 _let_9)))) (let ((_let_11 (bvand #x0000000000000001 (shr16 _let_1)))) (let ((_let_12 (shl1 x))) (let ((_let_13 (bvand #x0000000000000001 (shr16 _let_12)))) (let ((_let_14 (bvnot (shr4 (bvnot _let_7))))) (let ((_let_15 (bvand #x0000000000000001 (shr4 _let_3)))) (let ((_let_16 (bvand #x0000000000000001 _let_1))) (let ((_let_17 (bvand #x0000000000000001 x))) (let ((_let_18 (if0 _let_17 _let_14 _let_2))) (if0 (bvand #x0000000000000001 (bvor x _let_1)) (if0 _let_13 (if0 _let_11 (if0 _let_10 (if0 (bvand #x0000000000000001 (bvand x _let_1)) _let_14 (if0 (bvand #x0000000000000001 (shr16 _let_9)) _let_14 _let_4)) (if0 _let_17 _let_14 _let_4)) (if0 _let_10 (if0 _let_15 (if0 (bvand #x0000000000000001 (shr4 _let_9)) (if0 _let_16 _let_4 _let_14) _let_14) (if0 _let_8 _let_14 _let_18)) (if0 _let_15 (if0 _let_17 _let_14 _let_5) (if0 _let_17 _let_14 (if0 (bvand #x0000000000000001 (bvor x _let_3)) _let_2 _let_4))))) (if0 _let_11 (if0 _let_10 (if0 (bvand #x0000000000000001 (shr4 _let_7)) (if0 (shr1 (bvxor x (bvadd #x0000000000000001 x))) _let_14 _let_2) _let_14) _let_18) (if0 _let_10 (if0 _let_15 (if0 (bvand #x0000000000000001 (shr4 _let_12)) _let_14 (if0 _let_16 _let_2 _let_14)) (if0 _let_6 (if0 (bvand #x0000000000000001 (bvor x _let_7)) _let_14 _let_4) _let_14)) (if0 _let_15 (if0 (bvand #x0000000000000001 (bvadd x _let_3)) _let_2 _let_4) _let_14)))) (if0 _let_13 (if0 _let_11 (if0 (bvand #x0000000000000001 _let_7) _let_5 _let_2) _let_5) (if0 _let_11 (if0 _let_10 (if0 _let_8 (if0 _let_6 _let_2 _let_4) _let_4) _let_5) _let_5))))))))))))))))))))))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (bvnot x))) (if0 (bvand #x0000000000000001 _let_1) (bvnot (bvadd x (shl1 x))) _let_1)))

(define-fun f ((x (_ BitVec 64))) (_ BitVec 64) (let ((_let_1 (shr16 (shl1 x)))) (let ((_let_2 (bvnot x))) (let ((_let_3 (shr1 _let_2))) (let ((_let_4 (shr4 _let_3))) (let ((_let_5 (shr1 x))) (let ((_let_6 (bvand #x0000000000000001 (shr16 _let_5)))) (let ((_let_7 (bvand #x0000000000000001 x))) (let ((_let_8 (if0 _let_6 _let_1 _let_4))) (let ((_let_9 (bvand #x0000000000000001 (shr4 _let_5)))) (if0 (bvand #x0000000000000001 (shr16 _let_2)) (if0 (bvand #x0000000000000001 (shr4 x)) (if0 _let_7 (if0 (bvand #x0000000000000001 _let_3) (if0 _let_9 _let_8 (if0 (bvand #x0000000000000001 _let_1) _let_4 _let_8)) (if0 _let_9 _let_8 _let_4)) _let_4) (if0 _let_7 _let_8 _let_4)) (if0 _let_7 (if0 _let_6 _let_4 _let_1) _let_1))))))))))))
